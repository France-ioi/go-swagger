...
import (
	...
	"github.com/France-ioi/go-swagger/examples/file-server/restapi/operations"
	"github.com/France-ioi/go-swagger/examples/file-server/restapi/operations/uploads"
)
