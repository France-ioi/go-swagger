...
import (
	...
	"github.com/France-ioi/go-swagger/examples/stream-server/client"
	"github.com/France-ioi/go-swagger/examples/stream-server/client/operations"
	"github.com/France-ioi/go-swagger/examples/stream-server/models"
)
