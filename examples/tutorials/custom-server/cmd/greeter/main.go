...
import (
	...
	"github.com/France-ioi/go-swagger/examples/tutorials/custom-server/gen/restapi"
	"github.com/France-ioi/go-swagger/examples/tutorials/custom-server/gen/restapi/operations"
)
