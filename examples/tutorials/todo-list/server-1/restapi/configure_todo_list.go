...
import (
	...
	"github.com/France-ioi/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations"
	"github.com/France-ioi/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations/todos"
)
