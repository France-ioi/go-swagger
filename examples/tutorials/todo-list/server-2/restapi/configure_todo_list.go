...
import (
	...
	"github.com/France-ioi/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations"
	"github.com/France-ioi/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations/todos"
)
