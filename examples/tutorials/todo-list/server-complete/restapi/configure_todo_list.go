...
import (
	...
	"github.com/France-ioi/go-swagger/examples/tutorials/todo-list/server-complete/models"
	"github.com/France-ioi/go-swagger/examples/tutorials/todo-list/server-complete/restapi/operations"
	"github.com/France-ioi/go-swagger/examples/tutorials/todo-list/server-complete/restapi/operations/todos"
)
